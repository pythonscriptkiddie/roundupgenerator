...
main_menu_title = 'COMMANDS'
main_menu_options = ['search - SEARCH ARTICLES',
                     'add - ADD ARTICLE(S)', 'update - UPDATE/DELETE ARTICLE',
                     'cat_menu - ADD/UPDATE/DELETE CATEGORY', 'export - EXPORT ROUNDUP',
                     "cat_help - VIEW CATEGORIES", "cmd_help - VIEW COMMANDS", "exit - EXIT PROGRAM"]

#def display_title(command=''):
#    del command
#    print("The Roundup Generator v 3.0")
#    print()    
#    time.sleep(0.5)
#    display_menu(main_menu_title, main_menu_options)
#    
#def display_title2(x):
#    del x
#    print("The Roundup Generator v 3.0")
#    print()    
#    time.sleep(0.5)
